...
@Log4j2
@RequiredArgsConstructor //필드값을 보고 생성자를 만든다. final필드나 @NonNull이 붙은 필드용
...
public class BoardServiceImpl implements BoardService{
    ...
    public BoardDTO readOne(Long bno) {
        ...
        // 모델 메퍼를 이용하여 엔티티로 나온 board를 dto로 변환한다.
    ...
    public void modify(BoardDTO boardDTO) {
        ...
        board.change(board.getTitle(),boardDTO.getContent()); // 제목과 내용이 수정
        boardRepository.save(board); //pk가 데이터베이스에 있으면 update, 없으면 insert
    }
